package com.flysolo.servlet.auth;

import com.flysolo.controller.UserController;
...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        // TODO: Implementar password hashing cuando agregues la columna password a la tabla users
        ...
        if (user != null) {
            ...
            if (user.isAdmin()) {
                ...
                response.sendRedirect("dashboard?view=passenger");
            }
        } else {
